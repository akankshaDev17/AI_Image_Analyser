    ...
    try:
        with open(image_path,"rb") as image_file:
           ...
           def make_api_request(model):
                ...
                return response
        llama_17b_response=make_api_request("meta-llama/llama-4-scout-17b-16e-instruct")
        llama_17mb_response=make_api_request("meta-llama/llama-4-maverick-17b-128e-instruct")
        responses={}
        for model,response in [("llama_17b",llama_17b_response),
                               ("llama_17mb",llama_17mb_response)]:
...
if __name__=="__main__":
    ...
    query="What this image indicates tell the problem indicated in detail?"
